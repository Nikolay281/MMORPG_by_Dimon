    ...
    class Client
    {
        ...
        public class TCP
        {
            ...
            public void SendData(Packet _packet)
            {
                ...
                {
                    Console.WriteLine($"Ошибка отправки данных игроку {id} через TCP: {_ex}");
                }
            }
            ...
            private void ReceiveCallback(IAsyncResult _result)
            {
                ...
                {
                    Console.WriteLine($"Ошибка при получении данных TCP: {_ex}");
                    Server.clients[id].Disconnect();
                }
            }
        ...
        {
            Console.WriteLine($"{tcp.socket.Client.RemoteEndPoint} отключился.");
